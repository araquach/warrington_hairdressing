...
class RecruitApplicantController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('RecruitApplicant');
	...
	{
		$model=new RecruitApplicant('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['RecruitApplicant']))
			$model->attributes=$_GET['RecruitApplicant'];
