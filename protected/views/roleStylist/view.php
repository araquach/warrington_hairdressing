...
$this->menu=array(
	...
	array('label'=>'Update Stylist', 'url'=>array('update', 'id'=>$model->id)),
	array('label'=>'Delete Stylist', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
	array('label'=>'Manage Stylist', 'url'=>array('admin')),
);
?>

<h1>View Stylist #<?php echo $model->id; ?></h1>
