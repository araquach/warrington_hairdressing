...
<div class="view">
	...
	<?php echo CHtml::encode($data->current_emp); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('current_emp_des')); ?>:</b>
	<?php echo CHtml::encode($data->current_emp_des); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('qual_school')); ?>:</b>
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('adex1')); ?>:</b>
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('adex3')); ?>:</b>
	<?php echo CHtml::encode($data->adex3); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('adex4')); ?>:</b>
	<?php echo CHtml::encode($data->adex4); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('adex5')); ?>:</b>
	<?php echo CHtml::encode($data->adex5); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('adex6')); ?>:</b>
	<?php echo CHtml::encode($data->adex6); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('qual_hair')); ?>:</b>
	<?php echo CHtml::encode($data->qual_hair); ?>
	<br />
	...
	<?php echo CHtml::encode($data->why_us); ?>
	<br />
