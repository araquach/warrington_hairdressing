...
class aAdmin_holidayWidget extends CWidget
{
    ...
    public function run()
    {
        ...
        $this->render('admin_holidayWidget', array('total'=>$total, 'entitlement'=>$entitlement, 'remaining'=>$remaining, 'saturday'=>$saturday));
    }
}
